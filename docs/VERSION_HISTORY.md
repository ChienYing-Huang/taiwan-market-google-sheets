...
### v2.1.5 — 2026-09-16／09-17 問題修正（2026-09-18）
- 依使用者執行紀錄確認：非必要的 8 月 HTTP 307 請求連帶中止 9 月大盤擷取。
- 本月有資料即返回；共用指定日期解析器，新增有限次重試及官方備援路徑。
- 使用者確認 9 月結算當日起 ATM 改採現貨收盤；09-17 為 46,300。
- 修正 50 點目標未掛牌時仍顯示該履約價的問題，依契約雙邊掛牌及基準距離選取。
- 兩天官方快照、故障情境及季節切換合計 10 項回歸測試通過。
- 詳見 docs/releases/v2.1.5-upgrade.md；尚未部署線上試算表。
